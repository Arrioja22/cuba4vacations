...
//AGREGAR A LA BASE DE DATOS
    $sql_agregar = 'INSERT INTO paquetes (destino,nom_paquete,f_ingreso,f_salida,show_nocturno,nom_habitacion,nombre_cliente,apellido_cliente,correo_cliente,telefono,pais,cantidad_personas,comentario) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?) ';
    $sentencia_agregar = $pdo->prepare($sql_agregar);

    if ($sentencia_agregar->execute(array($destino,$nom_paquete,$fecha_ingreso,$fecha_salida,$show_nocturno,$nom_habitacion,$nom,$ape,$correo,$tel,$pais,$cant_personas,$comentario))) {
        echo 'Agregado <br>';
    }else {
      echo 'Error<br>';
    }
