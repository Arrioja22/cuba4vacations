...
$show_nocturno = $_POST['show_nocturno'];
...
//AGREGAR A LA BASE DE DATOS
  $sql_agregar = 'INSERT INTO paquetes (destino,nom_paquete,f_ingreso,f_salida,show_nocturno,nom_habitacion,nombre_cliente,apellido_cliente,correo_cliente,telefono,pais,comentario) VALUES (?,?,?,?,?,?,?,?,?,?,?,?) ';
    $sentencia_agregar = $pdo->prepare($sql_agregar);

    if ($sentencia_agregar->execute(array($destino,$nom_paquete,$fecha_ingreso,$fecha_salida,$show_nocturno,$nom_habitacion,$nom,$ape,$correo,$tel,$pais,$comentario))) {
        echo 'Agregado <br>';
    }else {
      echo 'Error<br>';
    }
...
try {
    ...
    $mail->Host = 'mx56.hostgator.mx';  // Specify main and backup SMTP servers
    $mail->SMTPAuth = true;                               // Enable SMTP authentication
    $mail->Username = 'paquetes@cuba4vacations.com';                 // SMTP username
    $mail->Password = 'paquetescuba4vacations';                           // SMTP password
    $mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 465;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('paquetes@cuba4vacations.com', 'Cuba4Vacations');
   ...
   // $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    // Optional name
    ...
    $mail->Subject = 'Correo con hosting';
/*     $mail->Body    = "
     <html>
     <body>
                ...
                <td valign="top" class="mobile-padding" style="padding:20px;">
                  <table cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr>
                      ...
                      <td style="padding-top:5px; border-top:1px solid #E7E7E7;">
                        Show nocturno: &nbsp; '.$show_nocturno.'.<br>
                        Habitacion: <br> 
                        '.$nom_habitacion.'.
                      </td>
                    </tr>
