              ...
              <form role="form" action="{{url('Destino/.$destino->id')}}" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="destino" name="destino" value="{{$destino->nombre_destino}}">
                  </div>
                  <div class="form-group">
                    <label for="descripcion">Texto Promocion</label>
                    <input type="text" class="form-control" id="descripcion"  name="descripcion" value="{{$destino->descripcion}}">
                  </div>
                </div>
                <!-- /.card-body -->
