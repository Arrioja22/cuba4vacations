...
<html lang="en-US">
  <head>
    ...
    <link href="{{@asset('form-vents/css/bootstrap-datepicker.css')}}" rel="stylesheet">
        <!-- Page style -->
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-md-6">
	                            ...
	                            <select class='form-control' name="destino" id="destino" required>
	                              ...
	                              <option value="habana" id="habana" selected> Habana</option>
	                              <option value="viñales" id="viñales">Viñales</option>
